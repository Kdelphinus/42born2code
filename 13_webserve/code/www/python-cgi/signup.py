...
# Parse the POST data to extract the received cookie and username
...
if received_cookie is not None:
    ...
    if received_cookie in session_dict:
        # Update the value associated with the cookie to the received username
        session_dict[received_cookie] = username
