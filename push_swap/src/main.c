...
/*   Updated: 2022/11/17 17:03:34 by myko             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	argc2(int argc, char **argv, t_stack *stack)
{
	char		**tmp;
	long long	tmpn;
	long long	i;
...
int	main(int argc, char **argv)
{
	...
	if (argc == 1)
		return (0);
	if (stack_init(argc, argv, &stack))
		return (1);
	stack.b = (long long *)malloc(sizeof(long long) * stack.a_len);
	if (!stack.b)
		return (1);
	stack.b_len = 0;
	return (0);
